...
//*************************************************************************************************************
        ...
        {
            string cb1 = comboBox2.SelectedValue.ToString();
...
//***************************************** finalizar ***************************************************
        private void button3_Click(object sender, EventArgs e)
        {
           try{
            ...
            String Consulta = "Select * from permisos where aplicaciones_idaplicaciones = '" + comboBox2.SelectedValue.ToString() + "' and roles_cod_roles ='" + comborol.SelectedValue.ToString() + "'";
            ...
            {
            dict.Add("aplicaciones_idaplicaciones", comboBox2.SelectedValue.ToString());
...
//*********************************************** boton de generar *****************************************
 ...
 //****************************************************************************************************************
        ...
        public void CARGARAPLICACIONES() {
            ...
            comboBox2.DataSource = db.consulta_ComboBox(consulta2);
            comboBox2.DisplayMember = "txaplicacion";
            comboBox2.ValueMember = "idaplicaciones";
            }
            catch (Exception e) { }
        }
//****************************************************************************************************************
